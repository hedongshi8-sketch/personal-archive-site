...
values
  ...
  ('12b244c6-6f54-1701-ac9b-d2496405d33e', 'barbarq', '菇霸争夺战配置表', 'excel', '玩法配置与数据拆分表，适合展示系统拆解、表结构和可落地配置能力。', array['Excel', '配置表', '数值拆解']::text[], '/portfolio-assets/barbarq/sheets/野蛮人大作战2-菇霸争夺战.xlsx', null, null, 'E:\工作相关\野蛮人大作战2-菇霸争夺战.xlsx', true, true, 11, '2026-04-13'::timestamptz),
  ('0147fb6e-5635-1e38-8923-654b00d21cd9', 'barbarq', '菇霸争夺战相关表格', 'excel', '补充表格，用于承接模式规则、字段整理与外围配置。', array['Excel', '补充表', '字段整理']::text[], '/portfolio-assets/barbarq/sheets/野蛮人大作战2-菇霸争夺战相关表格.xlsx', null, null, 'E:\工作相关\野蛮人大作战2-菇霸争夺战相关表格.xlsx', false, true, 12, '2026-04-01'::timestamptz),
  ...
  ('9e9741c7-ed1e-299a-9138-72025306d892', 'barbarq', '菇霸争夺战美术需求表', 'excel', '与美术需求 PDF 对应的表格版本，便于生产跟踪和字段管理。', array['Excel', '美术需求', '生产跟踪']::text[], '/portfolio-assets/barbarq/sheets/野蛮人大作战2-菇霸争夺战部分美术需求.xlsx', null, null, 'E:\工作相关\野蛮人大作战2-菇霸争夺战部分美术需求.xlsx', false, true, 14, '2026-04-01'::timestamptz),
  ...
  ('cccf7317-ba87-358a-bf5c-8d54aa6b7004', 'system-planner', '战意 / 骑砍2 / 全面战争系统拆解案', 'excel', '横向拆解多个战争题材游戏的系统结构、循环与可借鉴设计点。', array['系统拆解', 'Excel', '战争题材']::text[], '/portfolio-assets/system-planner/sheets/系统策划拆解案_战意_骑砍2_全面战争.xlsx', null, null, 'E:\策划文档\系统策划实习生投递包\最终投递版\系统策划拆解案_战意_骑砍2_全面战争.xlsx', true, true, 17, '2026-06-16'::timestamptz),
  ...
  ('7224c209-3fdd-9e72-fb05-76ec9aee59b2', 'game-town', '游戏小镇方案完善版', 'docx', '完整方案文档，包含玩法设定、系统结构、美术需求和开发说明。', array['方案文档', '模拟经营', 'DOCX']::text[], '/portfolio-assets/game-town/docs/游戏小镇方案V_0.2完善版(1).docx', null, null, 'E:\游戏小镇\游戏小镇方案V_0.2完善版(1).docx', false, true, 21, '2026-06-10'::timestamptz),
  ('31e1a52d-d6b9-4247-d3c8-e87882b376cd', 'game-town', '游戏小镇美术需求文档', 'html-prototype', '美术需求 HTML 文档，可在站内直接打开阅读。', array['美术需求', 'HTML', '生产协作']::text[], '/portfolio-assets/game-town/docs/游戏小镇美术需求文档.html', '/portfolio-assets/game-town/docs/游戏小镇美术需求文档.html', null, 'E:\游戏小镇\游戏小镇美术需求文档.html', false, true, 22, '2026-06-10'::timestamptz),
  ('76bcbb6e-a5dc-6860-9afa-116cffd763ed', 'game-town', '游戏小镇系统配置表合集', 'excel', 'NPC、物品、任务、土地、地域、事件、建筑、怪物、装备等 12 个配置表。', array['Excel', '配置表', '系统设计']::text[], '/portfolio-assets/game-town/sheets/NPC表.xlsx', null, null, 'E:\游戏小镇\相关表格', true, true, 23, '2026-06-10'::timestamptz),
  ('8524dbae-2398-ff06-801c-93bb4ff0c50e', 'game-town', '游戏小镇视觉概念图', 'image', '作为游戏小镇作品的视觉入口和缩略展示图。', array['视觉概念', '图片', '展示图']::text[], '/portfolio-assets/game-town/images/visual-concept.png', '/portfolio-assets/game-town/images/visual-concept.png', '/portfolio-assets/game-town/images/visual-concept.png', 'E:\游戏小镇\visual-concept.png', false, true, 24, '2026-06-09'::timestamptz),
  ('d490053d-eda9-b83f-6467-ccc978710b24', 'game-town', '游戏小镇完整打包文件', 'archive', '完整工程与作品素材打包，提供下载留档。', array['压缩包', '完整归档', '下载']::text[], '/portfolio-assets/game-town/archive/游戏小镇.rar', null, null, 'E:\游戏小镇\游戏小镇.rar', false, true, 25, '2026-06-11'::timestamptz)
on conflict (id) do update set
