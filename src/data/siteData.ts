...
export const readingNotes: ReadingNote[] = [
  {
    ...
    quote: "摘记：玩法要被一直琢磨；物品、过场、盈利和暂停画面都会改变玩家感受。",
    reflection: "",
    tags: ["玩法", "玩家体验", "设计文档"],
  ...
  },
  {
    ...
    title: "通关！游戏设计之道（第2版）",
    creator: "Scott Rogers",
    quote: "摘记：文档先抓住读者兴趣，再展开类型、流程、玩法细节和能让人记住的卖点。",
    reflection: "",
    tags: ["设计文档", "表达", "卖点"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：把体验当作核心问题，用不同透镜反复检查目标、情绪、机制和反馈。",
    reflection: "",
    tags: ["体验设计", "设计透镜", "复盘"],
    createdAt: "2026-06-26",
  },
  {
    ...
    title: "游戏设计艺术（第2版）",
    creator: "Jesse Schell",
    quote: "摘记：设计师需要在游戏、玩家和体验之间来回验证，而不是只堆功能清单。",
    reflection: "",
    tags: ["玩家体验", "系统拆解", "验证"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：先明确目标、核心机制和交互循环，再拆规则、界面、关卡与平衡。",
    reflection: "",
    tags: ["核心循环", "规则", "系统设计"],
    createdAt: "2026-06-26",
  },
  {
    ...
    title: "游戏设计基础",
    creator: "Ernest Adams",
    quote: "摘记：平衡不是把数值磨平，而是让选择、风险和回报形成可预期的张力。",
    reflection: "",
    tags: ["平衡", "数值", "选择"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：把游戏看成事件制造机；玩家记住的是故事化的变化，而不是孤立规则。",
    reflection: "",
    tags: ["体验引擎", "事件", "叙事反馈"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：机制可以被画成资源、行为和反馈回路；循环清楚，系统才可调。",
    reflection: "",
    tags: ["机制", "反馈循环", "经济系统"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：第一次大回报前的学习量越大，越需要小回报和循序渐进的教学。",
    reflection: "",
    tags: ["玩家心理", "教学", "奖励"],
    createdAt: "2026-06-26",
  },
  {
    ...
    title: "游戏设计入门：理解玩家思维",
    creator: "Zack Hiwiller",
    quote: "摘记：玩家动机并不相同；社交、成就、探索等背景会影响目标和奖励写法。",
    reflection: "",
    tags: ["玩家心理", "动机", "用户分层"],
    createdAt: "2026-06-26",
  },
  {
    ...
    quote: "摘记：情感设计要关注玩家如何从角色、社交线索和反馈中感到连接。",
    reflection: "",
    tags: ["游戏心理", "情感设计", "反馈"],
    createdAt: "2026-06-26",
  },
